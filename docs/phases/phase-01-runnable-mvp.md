...
- Public catalog listing import from authorized JSON feeds for local source-adapter testing.
...
- No backend database.
- Public catalog feed imports are local to the browser until backend source sync exists.
